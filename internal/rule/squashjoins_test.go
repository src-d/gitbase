		...
		},
		{
			...
			plan.NewProject(
				[]sql.Expression{
					...
					colT(1, sql.VarChar(40), gitbase.CommitsTableName, "commit_hash"),
					colT(2, sql.Text, gitbase.CommitsTableName, "commit_author_name"),
					colT(3, sql.VarChar(254), gitbase.CommitsTableName, "commit_author_email"),
					colT(4, sql.Timestamp, gitbase.CommitsTableName, "commit_author_when"),
					colT(5, sql.Text, gitbase.CommitsTableName, "committer_name"),
					colT(6, sql.VarChar(254), gitbase.CommitsTableName, "committer_email"),
					colT(7, sql.Timestamp, gitbase.CommitsTableName, "committer_when"),
					colT(8, sql.Text, gitbase.CommitsTableName, "commit_message"),
					colT(9, sql.VarChar(40), gitbase.CommitsTableName, "tree_hash"),
					colT(10, sql.Array(sql.VarChar(40)), gitbase.CommitsTableName, "commit_parents"),
				},
				plan.NewInnerJoin(
					plan.NewExchange(2,
		...
		},
		{
			...
			plan.NewProject(
				[]sql.Expression{
					...
					colT(2, sql.VarChar(40), gitbase.TreeEntriesTableName, "blob_hash"),
					colT(3, sql.VarChar(40), gitbase.TreeEntriesTableName, "tree_hash"),
					colT(4, sql.VarChar(16), gitbase.TreeEntriesTableName, "tree_entry_mode"),
				},
				plan.NewInnerJoin(
					plan.NewExchange(2,
		...
		},
		{
			...
			plan.NewProject(
				[]sql.Expression{
					...
					colT(1, sql.VarChar(40), gitbase.BlobsTableName, "blob_hash"),
		...
		},
		{
			...
			plan.NewProject(
				[]sql.Expression{
					...
					colT(6, sql.VarChar(40), gitbase.ReferencesTableName, "commit_hash"),
					colT(0, sql.Text, gitbase.BlobsTableName, "repository_id"),
					colT(1, sql.VarChar(40), gitbase.BlobsTableName, "blob_hash"),
					colT(2, sql.Int64, gitbase.BlobsTableName, "blob_size"),
					colT(3, sql.Blob, gitbase.BlobsTableName, "blob_content"),
		...
		},
		{
			...
			plan.NewProject(
				[]sql.Expression{
					...
					colT(5, sql.VarChar(40), gitbase.CommitsTableName, "commit_hash"),
					colT(6, sql.Text, gitbase.CommitsTableName, "commit_author_name"),
					colT(7, sql.VarChar(254), gitbase.CommitsTableName, "commit_author_email"),
					colT(8, sql.Timestamp, gitbase.CommitsTableName, "commit_author_when"),
					colT(9, sql.Text, gitbase.CommitsTableName, "committer_name"),
					colT(10, sql.VarChar(254), gitbase.CommitsTableName, "committer_email"),
					colT(11, sql.Timestamp, gitbase.CommitsTableName, "committer_when"),
					colT(12, sql.Text, gitbase.CommitsTableName, "commit_message"),
					colT(13, sql.VarChar(40), gitbase.CommitsTableName, "tree_hash"),
					colT(14, sql.Array(sql.VarChar(40)), gitbase.CommitsTableName, "commit_parents"),
					colT(0, sql.Text, gitbase.BlobsTableName, "repository_id"),
					colT(1, sql.VarChar(40), gitbase.BlobsTableName, "blob_hash"),
					colT(2, sql.Int64, gitbase.BlobsTableName, "blob_size"),
					colT(3, sql.Blob, gitbase.BlobsTableName, "blob_content"),
