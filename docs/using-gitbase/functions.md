...
You can check standard functions in [`go-mysql-server` documentation](https://github.com/src-d/go-mysql-server/tree/12ca4f8c777a8436a71015f531d840393e3c36e1#custom-functions).
