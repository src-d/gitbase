...
import (
	...
	vtenv "gopkg.in/src-d/go-vitess.v0/vt/env"
	"gopkg.in/src-d/go-vitess.v0/vt/tlstest"
	"gopkg.in/src-d/go-vitess.v0/vt/vttest"

	vttestpb "gopkg.in/src-d/go-vitess.v0/vt/proto/vttest"
)
